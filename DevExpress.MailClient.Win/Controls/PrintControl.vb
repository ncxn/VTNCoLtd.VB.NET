...
Namespace DevExpress.MailClient.Win.Controls
    Partial Public Class PrintControl
        ...
        Protected Overrides Sub OnRightToLeftChanged(ByVal e As EventArgs)
            ...
            pageButtonEdit.Properties.Buttons(0).IsLeft = Not WindowsFormsSettings.GetIsRightToLeft(Me)
            pageButtonEdit.Properties.Buttons(1).IsLeft = WindowsFormsSettings.GetIsRightToLeft(Me)
        End Sub
        ...
        Private Function GetMargins() As Margins
            ...
            Return New Margins(CInt((p.Left * 3.9)), CInt((p.Right * 3.9)), CInt((p.Top * 3.9)), CInt((p.Bottom * 3.9)))
        End Function
