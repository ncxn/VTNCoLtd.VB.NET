...
Namespace DevExpress.MailClient.Win.Controls
    Partial Public Class ExportControl
        ...
        Public Sub New()
            InitializeComponent()
        End Sub
        Private formats As New List(Of ImageFormat)() From {ImageFormat.Bmp, ImageFormat.Gif, ImageFormat.Jpeg, ImageFormat.Png, ImageFormat.Tiff, ImageFormat.Emf, ImageFormat.Wmf, ImageFormat.Png}
